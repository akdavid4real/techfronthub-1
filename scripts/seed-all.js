...
// ── Courses ────────────────────────────────────────────────────────────────
const COURSES = [
  { category: 24, tag: 'BOOTCAMP',    tagHot: true,  code: 'DA-201',   title: 'Data Analytics Bootcamp',        desc: 'Master Excel, SQL, Power BI and Python for real-world business analysis.',                    duration: '12 weeks', lessons: 86,  level: 'Intermediate', price: '₦185,000', old: '₦250,000', hue: 214 },
  { category: 23, tag: 'NEW',         tagHot: false, code: 'AI-110',   title: 'Applied AI & Automation',         desc: 'Build practical AI agents, prompt systems and automations for business.',                     duration: '8 weeks',  lessons: 62,  level: 'All levels',   price: '₦220,000', old: null,        hue: 225 },
  { category: 25, tag: 'POPULAR',     tagHot: true,  code: 'DVOP-305', title: 'DevOps Engineering Track',        desc: 'Linux, Git, Docker, Kubernetes, CI/CD and cloud deployment in one program.',                  duration: '14 weeks', lessons: 104, level: 'Advanced',     price: '₦265,000', old: '₦320,000', hue: 205 },
  { category: 27, tag: 'LIVE',        tagHot: false, code: 'WEB-140',  title: 'Full-Stack Web Development',      desc: 'HTML/CSS, JavaScript, React, Node and databases — ship a real product.',                      duration: '16 weeks', lessons: 120, level: 'Beginner',     price: '₦195,000', old: null,        hue: 218 },
  { category: 26, tag: 'BOOTCAMP',    tagHot: false, code: 'DM-070',   title: 'Digital Marketing Mastery',       desc: 'SEO, paid ads, content, email and analytics — end-to-end playbook.',                         duration: '6 weeks',  lessons: 48,  level: 'Beginner',     price: '₦95,000',  old: '₦130,000', hue: 230 },
  { category: 28, tag: 'BOOTCAMP',    tagHot: false, code: 'KIDS-020', title: 'Tech for Kids (Ages 8–14)',       desc: 'Scratch, Python and robotics fundamentals through projects and play.',                        duration: '10 weeks', lessons: 40,  level: 'Beginner',     price: '₦75,000',  old: null,        hue: 210 },
  { category: 29, tag: 'ADVANCED',    tagHot: false, code: 'HR-150',   title: 'HR Tech & People Analytics',      desc: 'Modern HR tooling, analytics dashboards and workforce reporting.',                             duration: '8 weeks',  lessons: 54,  level: 'Intermediate', price: '₦160,000', old: null,        hue: 222 },
  { category: 30, tag: 'NEW',         tagHot: true,  code: 'SEC-200',  title: 'Cybersecurity Fundamentals',      desc: 'Threat modelling, network defence, ethical hacking basics and compliance.',                   duration: '10 weeks', lessons: 72,  level: 'Intermediate', price: '₦210,000', old: '₦260,000', hue: 208 },
  { category: 31, tag: 'BOOTCAMP',    tagHot: false, code: 'CLD-180',  title: 'Cloud Computing (AWS)',           desc: 'EC2, S3, Lambda, RDS and serverless — architect and deploy on AWS.',                         duration: '12 weeks', lessons: 90,  level: 'Intermediate', price: '₦240,000', old: null,        hue: 200 },
  { category: 32, tag: 'POPULAR',     tagHot: true,  code: 'PY-130',   title: 'Python for Data Science',         desc: 'NumPy, Pandas, Matplotlib, Scikit-learn and real ML projects from scratch.',                  duration: '10 weeks', lessons: 78,  level: 'Beginner',     price: '₦155,000', old: '₦200,000', hue: 217 },
  { category: 33, tag: 'BOOTCAMP',    tagHot: false, code: 'UX-090',   title: 'UI/UX Design Fundamentals',       desc: 'Figma, design systems, user research and end-to-end product prototyping.',                    duration: '8 weeks',  lessons: 58,  level: 'Beginner',     price: '₦130,000', old: null,        hue: 235 },
]
...
// ── Udemy Courses ──────────────────────────────────────────────────────────
const UDEMY = [
  { title: 'The Complete Python Pro Masterclass',       author: 'Adebayo O. · TECHFRONT',  rating: 4.8, count: '12,840', hours: '38.5 hrs', price: '₦7,500',  udemyUrl: 'https://www.udemy.com/course/complete-python-pro-masterclass/', hue: 214, sortOrder: 1 },
  { title: 'Power BI for Business Analysts',            author: 'Chioma E. · TECHFRONT',   rating: 4.7, count: '6,210',  hours: '22 hrs',   price: '₦6,500',  udemyUrl: 'https://www.udemy.com/course/power-bi-for-business-analysts/',  hue: 205, sortOrder: 2 },
  { title: 'AWS Certified Solutions Architect',         author: 'Ibrahim K. · TECHFRONT',  rating: 4.9, count: '18,902', hours: '41 hrs',   price: '₦9,000',  udemyUrl: 'https://www.udemy.com/course/aws-certified-solutions-architect-associate/', hue: 225, sortOrder: 3 },
  { title: 'ChatGPT & AI Automation for Work',          author: 'Tola A. · TECHFRONT',     rating: 4.8, count: '9,470',  hours: '14.5 hrs', price: '₦6,000',  udemyUrl: 'https://www.udemy.com/course/chatgpt-ai-automation-for-work/',  hue: 220, sortOrder: 4 },
  { title: 'SQL for Absolute Beginners',                author: 'Chioma E. · TECHFRONT',   rating: 4.6, count: '4,380',  hours: '11 hrs',   price: '₦5,000',  udemyUrl: 'https://www.udemy.com/course/sql-for-absolute-beginners/',      hue: 208, sortOrder: 5 },
  { title: 'Docker & Kubernetes in Practice',           author: 'Ibrahim K. · TECHFRONT',  rating: 4.8, count: '7,650',  hours: '29 hrs',   price: '₦8,000',  udemyUrl: 'https://www.udemy.com/course/docker-kubernetes-in-practice/',   hue: 202, sortOrder: 6 },
  { title: 'Digital Marketing from Scratch',            author: 'Funmi B. · TECHFRONT',    rating: 4.5, count: '3,210',  hours: '18 hrs',   price: '₦5,500',  udemyUrl: 'https://www.udemy.com/course/digital-marketing-from-scratch/', hue: 230, sortOrder: 7 },
  { title: 'Excel for Data Analysis',                   author: 'Adebayo O. · TECHFRONT',  rating: 4.7, count: '8,940',  hours: '16 hrs',   price: '₦5,500',  udemyUrl: 'https://www.udemy.com/course/excel-for-data-analysis/',         hue: 218, sortOrder: 8 },
  { title: 'React & Next.js Full-Stack Bootcamp',       author: 'Seun K. · TECHFRONT',     rating: 4.8, count: '5,520',  hours: '34 hrs',   price: '₦7,500',  udemyUrl: 'https://www.udemy.com/course/react-nextjs-full-stack-bootcamp/', hue: 215, sortOrder: 9 },
  { title: 'Cybersecurity Essentials for Beginners',    author: 'Bayo M. · TECHFRONT',     rating: 4.6, count: '2,890',  hours: '20 hrs',   price: '₦6,500',  udemyUrl: 'https://www.udemy.com/course/cybersecurity-essentials-beginners/', hue: 210, sortOrder: 10 },
]
